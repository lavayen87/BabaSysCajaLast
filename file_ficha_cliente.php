        ...
        <div class="row">
            <div id="content" class="col-lg-12">
                    ...
                    ?>
                        ...
                        <div class="input-group">
                            <div style='width: 20%;'>Cliente</div>
                                ...
                                <input type="text" readonly style="display: inline-block; background: white;" class="form-control" name="nombre" id_cliente="<?=$row['id_cliente']?>" value="<?=$row['nombre']?>" >
                        ...
                        <div class="input-group">
                            <div style='width: 20%;'>Teléfono</div>
                                ...
                                <input type="text" readonly style="display: inline-block; background: white;" class="form-control" name="telefono" id_cliente="<?=$row['id_cliente']?>"  value="<?=$row['telefono']?>" >
                        ...
                        <div class="input-group">
                            <div style='width: 20%;'>Lote</div>
                                ...
                                <input type="text" disabled style="display: inline-block; background: #E7F5F2;" class="form-control" name="lote" id="<?=$row['id_cliente']?>" value="<?=$row['lote']?>" maxlength="6">
                        ...
                        $div = "";
                        if($res_posesion->num_rows == 4)
                        {
                            $qry_forma_pago = "SELECT forma_pago FROM det_servicio
                            WHERE (lote = '$codigo') AND (servicio = 'Red Cloacas')";
                            ...
                            $div.= "<p style='width: 45%; margin-left: 20%; margin-top:5px;'>
                                    ...
                                    <span style='float: right;background: #11F3D2'>Forma de pago: <strong>".$forma_pago."</strong></span>
                                    <p>
                                    </br>";
                        }
                        else{
                            $div.= "<p style='margin-left: 20%; margin-top:5px;'>
                                    <span style='background: #E5E6D8'>Posesión: <strong>NO</strong></span>
                                    <p>";
                        }
                ...
                <?php      
                    ...
                    echo "<script>   
                          window.location = 'buscar_lotes.php';
                          </script>";
                }
                ?>
            </div>
