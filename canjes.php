		...
		if($moneda2 == 'dolares')
		{
			...
			if($op > 0)
			{
				...
				if($ultimo_cobro > 0.00)
				{
					if($pesos == [])
					{
						$pesos_a_sumar = ($ultimo_cobro + $ing_servicio + $ingreso);
					}
					else
					{
						$pesos_a_sumar = ($pesos + $ingreso);
				...
				$insert = "INSERT IGNORE INTO caja_gral VALUES ('','$numero_caja','$fecha','$fecha','Ing $ $detalle',0,'$ingreso',0,'$pesos_a_sumar',0,0,0,1,0)";
				$result_insert = mysqli_query($connection, $insert);

				$insert = "INSERT IGNORE INTO caja_gral VALUES ('','$numero_caja','$fecha','$fecha','Egr US$ $detalle',0,0,'$egreso',0,'$dolares_a_restar',0,0,2,0)";
				$result_insert = mysqli_query($connection, $insert);
		...
		else
		{
			...
			if($moneda2 == 'euros')
			{
				...
				if($op > 0)
				{
					...
					$insert = "INSERT IGNORE INTO caja_gral VALUES ('','$numero_caja','$fecha','$fecha','Egr € $detalle',0,0,'$egreso',0,0,'$euros_a_restar',0,3,0)";
					$result_insert = mysqli_query($connection, $insert);
	...
	case 'dolares':	//compra de dolares
		...
		if($moneda2 == 'pesos')
		{
			...
			if($op > 0)
			{
				...
				$insert = "INSERT IGNORE INTO caja_gral VALUES ('','$numero_caja','$fecha','$fecha','Ing US$ $detalle',0,'$ingreso',0,0,'$dolares_a_sumar',0,0,2,0)";
				$result_insert = mysqli_query($connection, $insert);

				$insert = "INSERT IGNORE INTO caja_gral VALUES ('','$numero_caja','$fecha','$fecha','Egr $ $detalle',0,0,'$egreso','$pesos_a_restar',0,0,0,1,0)";
				$result_insert = mysqli_query($connection, $insert);
	...
	case 'euros': // compra de euros
		...
		if($moneda2 == 'pesos')
		{
			...
			if($op > 0)
			{
				...
				$insert = "INSERT IGNORE INTO caja_gral VALUES ('','$numero_caja','$fecha','$fecha','Ing € $detalle',0,'$ingreso',0,0,0,'$euros_a_sumar',0,3,0)";
				$result_insert = mysqli_query($connection, $insert);
