...
if($_SESSION['active'])
{
	...
	{
		$cantidad = '$'.number_format($datos['egreso'],2,',','.');
		$aux = number_format($datos['egreso'],2,',','.');
		...
		{
		    $cantidad = '$US '.(int)$datos['egreso'];
		    $aux = number_format($datos['egreso'],2,',','.');//$datos['egreso'];	 original
		    if( parte_entera(strval($aux)) <> 0)
		    {	
...
<div id="page_pdf">
	...
	<table id="factura_cliente">
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					<span class="h2"><?php echo strtoupper('Egreso'); ?></span>
			...
			<td class="info_cliente">
				<div class="round">
					<!--span class="h3">Detalle</span-->
						...
						<div>
							<p style="display: inline-block;">N° de egreso: 
								<strong><?php echo $numero; ?></strong> 
							</p>

							<p style="display: inline-block; margin-left:140px;">
								Fecha: <strong><?php echo fecha_min($hoy); ?></strong>
							</p>
						...
						<p> fecha de egreso: <strong><?php echo fecha_min($fecha);?></strong></p>
						<p> Egreso en Nº de caja: <strong><?php echo "$caja";?></strong></p>
	...
	<?php
		if(strlen($texto1." ".$texto2) > 67)
			...
			echo "<br><br><br><br><br><br><br><br><b>";
		}
	?>
