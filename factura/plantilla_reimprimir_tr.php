				...
				<div class="round">
					<!--span class="h3">Detalle</span-->
						...
						<div style="width:100%; padding-top: 10px; margin-top: 7px; margin-bottom: -15px;">
								...
								<!--div id="checks-right" style="display: inline-block;"-->
									<?php
										if($band == 1){
											if($c > 4){
												echo "<div id='checks-right' style='display: inline-block; height: 9.4%;'>".$k."</div>";
					...
					<!--span class="h3">Detalle</span-->
						...
						<div style="width:100%; padding-top: 10px; margin-top: 7px; margin-bottom: -15px;">
								...
								<?php
										if($band == 1){
											if($c > 4){
												echo "<div id='checks-right' style='display: inline-block; height: 25.2%;'>".$k."</div>";
