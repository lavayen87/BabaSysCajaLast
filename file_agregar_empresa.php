          ...
          <div class="alert alert-success" role="alert">
            ...
            <div class="container">
              <div class="form-group col-md-6">
                ...
                <br>
                <button id="agregar-empresa" class="btn btn-success">Agregar</button>
                <button id="cancelar-empresa" class="btn btn-secondary" style="display: inline-block;">Cancelar</button>
                <br><br>
