...
echo "Cantidad de elemntos: ".count($l)."</br>";     
...
$findme   = 'CERO';
		...
		if ($pos === false) {
		    echo "La cadena '$findme' no fue encontrada en la cadena '$texto1'";
		} else {
		    echo "La cadena '$findme' fue encontrada en la cadena '$texto1'";
		    echo " y existe en la posición $pos";
		}
		echo "</br>";
		echo "La nueva cadena es: ".str_replace($findme, "", $texto1);
		echo "</br>";
		...
		echo "Cantidad de elemntos: ".count($lista)."</br>";
