<?php
    ...
    $update = "UPDATE det_servicio SET forma_pago = 'FINANCIADO' 
    ...
    <div style="width: 100%; border: none;" cellspacing="4mm" cellpadding="0">
        ...
        <div style="height: 50%; margin-top:10px;">
            ...
            <div class="zone" style=" vertical-align: middle; text-align: justify; border:1px solid green; margin-top: 4px; width: 97.3%;">
                ...
                <p align="justify">
                Por la presente, el/la Señor/a <strong><?php echo $titular;?></strong>, D.N.I. Nº <strong><?php echo $tdni;?></strong>, comprador/a por boleto de compra-venta del lote Nº <strong><?php echo $lote;?></strong>, del loteo <strong><?php echo $loteo;?></strong>, reconoce adeudar a <?php echo $propietario; ?>, la suma de <strong><?php echo $textoprecio;?></strong> en concepto de costo proporcional a las obras de red cloacal efecutadas en el loteo. Dicha suma será abonada de la siguiente manera: en el día de la fecha abona la suma de <strong><?php echo $textoanticipo; ?></strong>. El saldo restante de <strong><?php echo $textosafn; ?></strong> será abonado en <strong><?php echo $textocantcuotas ?></strong> cuotas mensuales, iguales, mensuales, consecutivas y ajustables de <strong><?php echo $textovalorcuota;?></strong> cada una, actualizables con el índice de la construcción (ICC), con vencimiento la primera de ellas en fecha <strong><?php echo $vnto; ?></strong> y así sucesivamente las posteriores. Tal actualización será aplicada mensualmente sobre el total de las cuotas restantes, tomando como monto de capital el correspondiente al de la cuota del mes inmediato anterior vencido. Asimismo,  en caso de pago fuera de término, se aplicará un interés punitorio equivalente a la tasa activa que cobra el Banco Macro para las operaciones en descubierto sin autorización. Tal interés se aplicará sobre el importe de capital actualizado vigente a la fecha del efectivo pago.-
                </p>
