          ...
          <div class="alert alert-success" role="alert"> 
            ...
            <div style="100%; overflow: hidden;">
              ...
              <div class="form-group col-md-6"style="width: 40%; float: left; "> 
                  ...
                  <input id="importe-my-check" type="number" style='width: 100%; height: 29px; border-radius: 5px 5px 5px 5px;'>
                  <?php
                   echo  "<script>
              ...
              <!--tabla de cheques-->
              <div class="form-group col-md-6 content-table-scroll mis_cheques" style="width: 58%;  float: right;">
                    
                    <div id="no-my-cheq" style="display: none; width:100%; text-align: center;">
                            ...
                            <?php
                              ...
                              if($res->num_rows > 0)
                              {
                                while($datos = mysqli_fetch_array($res))
                                {
                                  ...
                                  if($datos['activo'] <= 2)
                                    echo "<td style='text-align: left;'>"."<input type='checkbox' id='".$datos['id_cheque']."' name='mi_check' value='0'>"."</td></tr>";
            ...
            <div class="form-group col-md-6" style="width: 40%; float: left;">
              <button id="aceptar-solicitud-my-check" class="btn btn-primary" style="display: inline-block;">Aceptar</button>
